...
class AuthServiceIntegrationTest {
    ...
    class Login {
        ...
        public void login_validRequest_Success(){
            //given
            AuthSignupRequestDto signupDto = new AuthSignupRequestDto("test@test.com", "이름", "password", address);
            authService.signup(signupDto);

            AuthLoginRequestDto loginDto = new AuthLoginRequestDto(signupDto.email(), signupDto.password());
        ...
        public void login_WrongPassword_ExceptionThrown(){
            ...
            AuthLoginRequestDto loginDto = new AuthLoginRequestDto(signupDto.email(), "wrongPassword");
